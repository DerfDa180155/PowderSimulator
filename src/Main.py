...
class main:
    def __init__(self):
        ...
        self.buttons.append(Button.Button(self.screen, 500, 1430, 50, 50, (255,255,0), "border", "Border"))
        self.buttons.append(Button.Button(self.screen, 600, 1430, 50, 50, (255,255,0), "clear", "Clear"))
        ...
        self.buttons.append(Button.Button(self.screen, 1450, 1430, 50, 50, (112,128,144), "select5", "Lava"))
