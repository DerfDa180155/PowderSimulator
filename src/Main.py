...
class main:
    def __init__(self):
        ...
        self.buttons.append(Button.Button(self.screen, 190, 1430, 50, 50, (255,255,0), "stop simulation", "Stop"))
        self.buttons.append(Button.Button(self.screen, 280, 1430, 50, 50, (255,255,0), "step one", "Step one"))
        self.buttons.append(Button.Button(self.screen, 370, 1430, 50, 50, (255,255,0), "speed", "Speed"))
        self.buttons.append(Button.Button(self.screen, 460, 1430, 50, 50, (255,255,0), "border", "Border"))
        self.buttons.append(Button.Button(self.screen, 550, 1430, 50, 50, (255,255,0), "clear", "Clear"))
        self.buttons.append(Button.Button(self.screen, 640, 1430, 50, 50, (255,255,0), "new board", "New Board"))
        self.buttons.append(Button.Button(self.screen, 730, 1430, 50, 50, (255,255,0), "new x", "X"))
        self.buttons.append(Button.Button(self.screen, 820, 1430, 50, 50, (255,255,0), "new y", "Y"))
        self.buttons.append(Button.Button(self.screen, 910, 1430, 50, 50, (255,255,0), "place size", "Place Size"))
        self.buttons.append(Button.Button(self.screen, 1000, 1430, 50, 50, (255,238,140), "select1", "Sand"))
        self.buttons.append(Button.Button(self.screen, 1090, 1430, 50, 50, (30,144,255), "select2", "Water"))
        self.buttons.append(Button.Button(self.screen, 1180, 1430, 50, 50, (128, 128, 128), "select3", "Metal"))
        self.buttons.append(Button.Button(self.screen, 1270, 1430, 50, 50, (112,128,144), "select4", "Stone"))
        self.buttons.append(Button.Button(self.screen, 1360, 1430, 50, 50, (255,144,0), "select5", "Lava"))


        self.buttons.append(Button.Button(self.screen, 1280, 40, 50, 50, (255,255,0), "save", "Save"))
        self.buttons.append(Button.Button(self.screen, 1340, 40, 50, 50, (255,255,0), "load", "Load"))
    ...
    def run(self):
        ...
        while self.running:
            ...
            self.drawText("Powder Simulator", 50, (255,255,255), self.windowWidth / 2, 50)
                ...
                if button.isleftClicked:
                    ...
                    match button.onClick:
                        ...
                        case "select4":
                            ...
                            button.isSelected = True
                        case "select5":
                            self.pouderSimulator.currentElement = "Lava"
                            self.resetButtonSelection()
                            button.isSelected = True
                        case "save":
